...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(76370);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 48738)), "/home/aa019/dev/kkanbu-ninja/src/app/request/page.tsx"],
    ...
    const pages = ["/home/aa019/dev/kkanbu-ninja/src/app/request/page.tsx"];
...
var TableContainer = __webpack_require__(20475);
...
;// CONCATENATED MODULE: ./src/app/sign/button.tsx
...
const deleteRequest = async (objectWithData)=>{
...
const miliduration2date = (deltaTime)=>{
...
function Page(props) {
    ...
    const [requestList, setRequestList] = (0,react_.useState)(requestData);
    const [request, setRequest] = (0,react_.useState)("");
    const [password, setPassword] = (0,react_.useState)("");
    const [requester, setRequester] = (0,react_.useState)("");
    ...
    const deleteConfirm = async (data)=>{
        ...
        if ("success" === res) {
            setRequestList(requestList.filter((req)=>req._id !== data._id));
        } else {
            await getNewList();
        }
    };
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 45526))
...
const proxy = (0,module_proxy.createProxy)("/home/aa019/dev/kkanbu-ninja/src/app/request/list.tsx")
...
;// CONCATENATED MODULE: ./src/app/request/page.tsx
...
async function getRequestData() {
    const res = await fetch(`${process.env.host}/api/request`, {
        next: {
            revalidate: 1
        }
    }); //1 min cache
...
var __webpack_exports__ = __webpack_require__.X(0, [961,904,700,277,370,223,503], () => (__webpack_exec__(42843)));
